...
DropFields_node1718628925592 = DropFields.apply(frame=Join_node1718628762354, paths=["user", "timestamp", "x", "y", "z"], transformation_ctx="DropFields_node1718628925592")

# Script generated for node Amazon S3
AmazonS3_node1718629113961 = glueContext.write_dynamic_frame.from_options(frame=DropFields_node1718628925592, connection_type="s3", format="json", connection_options={"path": "s3://stedi-dragos/customer/curated/", "partitionKeys": []}, transformation_ctx="AmazonS3_node1718629113961")
